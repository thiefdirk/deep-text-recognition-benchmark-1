...
python infer.py --image D:\outputs\image_crops/ --saved_model C:\deep-text-recognition-benchmark-vit\saved_models/vitstr_tiny_patch16_224-Seed1111/best_accuracy.pth --model C:\deep-text-recognition-benchmark-vit/vitstr_tiny_patch16_224.pth --Transformer --Transformation None
'''
