...
python infer.py --image C:\deep-text-recognition-benchmark-vit\demo_image\crop_7.png --saved_model C:\deep-text-recognition-benchmark-vit\saved_models/vitstr_tiny_patch16_224-Seed1111/best_accuracy.pth --model C:\deep-text-recognition-benchmark-vit/vitstr_tiny_patch16_224.pth --Transformer --Transformation None
'''
...
if __name__ == '__main__':
    ...
    args.saved_model = 'C:\deep-text-recognition-benchmark-vit\saved_models/vitstr_tiny_patch16_224-Seed1111/best_accuracy.pth'
    args.model = 'C:\deep-text-recognition-benchmark-vit/vitstr_tiny_patch16_224.pth'
